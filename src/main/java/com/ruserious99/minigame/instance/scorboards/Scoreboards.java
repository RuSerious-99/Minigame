package com.ruserious99.minigame.instance.scorboards;

import com.ruserious99.minigame.instance.Arena;
import com.ruserious99.minigame.instance.game.BlockGame;
import com.ruserious99.minigame.instance.game.CodStronghold;
import com.ruserious99.minigame.instance.game.PvpGame;
import com.ruserious99.minigame.instance.game.Wak_A_Block;
...
public class Scoreboards {
    ...
    private  void setObjPvp(Objective obj, Player player, Scoreboard board) {
        ...
        obj.getScore(" ").setScore(3);
        obj.getScore(ChatColor.DARK_PURPLE + "Players Online: " + ChatColor.GREEN + (Bukkit.getOnlinePlayers().size() + " ")).setScore(2);
        obj.getScore(ChatColor.DARK_PURPLE + "         Kills: " + ChatColor.GREEN + PvpGame.kills.get(player.getUniqueId())).setScore(1);
    ...
    private  String getHeaderString(Player player) {
        return switch (player.getWorld().getName()) {
            ...
            case "arena3" -> "&a&l<< &2&lWak-A-Block &a&l>>";
